...
# Install Python, SQLite, pip, supervisor, nginx, git, and distutils
echo "Installing dependencies..."
apt-get update
apt-get install -y python3-dev python3-venv sqlite3 python3-pip supervisor nginx git python3-distutils
